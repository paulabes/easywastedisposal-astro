...
export const servicesMeta: Record<ServiceSlug, ServiceMeta> = {
  ...
  'furniture-bulky-item-removal': {
    ...
    faqs: [
      { question: "How much does it cost to have a sofa removed?", answer: "Sofa removal through Easy Waste Disposal starts from £40 for a single item such as a two-seater sofa. Larger pieces like corner units, sofa beds, or L-shaped sofas typically cost between £50 and £80 depending on size and access. All prices are quoted upfront before work begins, with no hidden fees or surcharges. A price-match guarantee is offered on every job. To book, call 07342 877 759 - same-day collection is available across Haringey, Islington, Camden, Westminster, Hackney, and Enfield." },
      ...
      { question: "Is your service faster than council bulky waste collection?", answer: "Easy Waste Disposal offers same-day and next-day furniture collection, compared to council bulky waste services in London which typically require a two-to-four-week wait. Most bookings made before midday qualify for same-day collection, with the crew arriving within 2-4 hours. The service covers Haringey, Islington, Camden, Westminster, Hackney, Enfield, and surrounding areas, 7 days a week from 7am to 8pm. Single items start from £40, which is often comparable to or cheaper than council collection fees." },
      { question: "What bulky items do you accept?", answer: "Easy Waste Disposal accepts all large household items including sofas, beds, mattresses, wardrobes, dining tables, desks, chest of drawers, bookcases, display cabinets, and garden furniture. White goods such as fridges, freezers, washing machines, and dishwashers are also collected and disposed of in compliance with WEEE regulations. The only items not accepted are hazardous materials such as asbestos, chemicals, and gas canisters. All collections include a waste transfer note confirming disposal by a licensed carrier (licence CBDU429337)." },
  ...
  'builders-waste-removal': {
    ...
    faqs: [
      { question: "How much does builders waste removal cost?", answer: "Builders waste removal through Easy Waste Disposal starts from £60 for small loads of rubble or timber offcuts. A full van load of mixed construction waste typically costs between £250 and £350, with heavier materials like concrete and soil at the upper end due to weight. All prices are quoted upfront before work begins, with no hidden fees. This is often cheaper than skip hire once permit fees, delivery charges, and overfill surcharges are factored in. Call 07342 877 759 for a free quote." },
  ...
  'appliance-disposal': {
    ...
    faqs: [
      { question: "How much does appliance disposal cost?", answer: "Appliance disposal through Easy Waste Disposal starts from £40 for a single item such as a microwave or small appliance. Larger items like fridges, washing machines, and American-style fridge-freezers typically cost between £50 and £80 depending on size and access. Multiple appliances can be collected in a single visit at a reduced per-item rate. All prices are quoted upfront before work begins with no hidden fees. Call 07342 877 759 to book same-day or next-day collection." },
      ...
      { question: "Do you offer same-day appliance collection?", answer: "Same-day appliance collection is available from Easy Waste Disposal when booked before midday, with the crew typically arriving within 2-4 hours. Next-day collection is available for bookings made later in the day. The service operates 7 days a week from 7am to 8pm, covering Haringey, Islington, Camden, Westminster, Hackney, Enfield, and surrounding areas. Prices start from £40 for a single appliance. Call 07342 877 759 to book. Easy Waste Disposal holds Environment Agency waste carrier licence CBDU429337." },
    ],
  },
  'wait-and-load': {
    name: 'Wait & Load',
